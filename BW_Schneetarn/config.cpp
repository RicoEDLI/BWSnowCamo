...
class CfgVehicles
{
	...
	class B_BW_Unit_Snow : I_soldier_F
	{
		...
		hiddenSelectionsTextures[] = {
			"\BW_Schneetarn\data\tex\bw_kleidung_schnee_co.paa"
		};
	};
	class B_BW_Schnee_Rifleman: B_Soldier_base_F
	{
		...
		hiddenSelectionsTextures[] = {"\BW_Schneetarn\data\tex\bw_kleidung_schnee_co.paa"};
...
class CfgWeapons
{
	...
	class BW_Unit_Snow: U_I_CombatUniform
	{
		...
		picture = "\BW_Schneetarn\data\logo\Kleidunglogo.paa";
		hiddenSelectionsTextures[] = {
			"\BW_Schneetarn\data\tex\bw_kleidung_schnee_co.paa"
		};
	...
	class BW_M92_Snow: ItemCore
	{
		...
		picture = "\BW_Schneetarn\data\logo\Helmlogo.paa";
		model = "BW_Schneetarn\data\model\bwa3_m92.p3d";
		hiddenSelections[] = {
			"Camo"
		};
		hiddenSelectionsTextures[] = {
			"\BW_Schneetarn\data\tex\bw_m92_schnee_co.paa"
		};
		class ItemInfo: HeadgearItem
		{
			mass = 40;
			uniformModel = "BW_Schneetarn\data\model\bwa3_m92.p3d";
			modelSides[] = {3,1};
			passThrough = 0.75;
			hiddenSelections[] =
			{
...
class CfgFactionClasses
{
	...
	{
		icon="\BW_Schneetarn\data\logo\BW_Logo.paa";
